...
export class SynapseRouter {
    ...
    constructor(chainId: number, provider: Provider) {
        ...
        this.routerContract = new Contract(ROUTER_ADDRESS[chainId as keyof object], SynapseRouter.INTERFACE, provider) as SynapseRouterContract
    }

    public async getAmountOut( 
        tokenIn: string,
        tokenOut: string,
        amountIn: BigintIsh): Promise<any> {
    ...
    public async getOriginAmountOut( 
        ...
        amountIn: BigintIsh): Promise<any> {
            ...
            return this.routerContract.getOriginAmountOut(tokenIn, bridgeTokens, amountIn);
    }
    ...
    public async bridge(
        ...
        return this.routerContract.populateTransaction.bridge(to, chainId, token, amount, originQuery, destQuery, { value: 0});
    }
}
