...
import type { SynapseCCTP, SynapseCCTPInterface } from "../SynapseCCTP";
...
export class SynapseCCTP__factory {
  static readonly abi = _abi;
  static createInterface(): SynapseCCTPInterface {
    return new utils.Interface(_abi) as SynapseCCTPInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SynapseCCTP {
    return new Contract(address, _abi, signerOrProvider) as SynapseCCTP;
  }
}
