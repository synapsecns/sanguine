...
let providers_1 = require('@ethersproject/providers')
let sdk_router_1 = require('@synapsecns/sdk-router')
let bignumber_1 = require('@ethersproject/bignumber')
let units_1 = require('@ethersproject/units')
let e = require('express')
let chainsData = require('./config/chains.json')
let tokensData = require('./config/tokens.json')
//@ts-ignore
let app = e()
let tokens = tokensData
let chains = chainsData
// Constants
let TEN = bignumber_1.BigNumber.from(10)
let tokenHtml = Object.keys(tokens)
  .map(function (symbol) {
    return (
      '<b>' +
      String(symbol) +
...
let providers = []
let chainIds = []
for (let _i = 0, chains_1 = chains; _i < chains_1.length; _i++) {
  var chain = chains_1[_i]
  providers.push(new providers_1.JsonRpcProvider(chain.rpc))
  chainIds.push(chain.id)
}
// Define the sdk
let Synapse = new sdk_router_1.SynapseSDK(chainIds, providers)
...
app.get('/swap', function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    let query; var chainId; var fromTokenSymbol; var toTokenSymbol; var fromTokenAddress; var toTokenAddress; var fromTokenDecimals; var toTokenDecimals; var amount;
    let _a; var _b; var _c; var _d; var _e; var _f; var _g; var _h
    return __generator(this, function (_j) {
      ...
      fromTokenAddress =
        (_b =
          (_a = tokens[fromTokenSymbol]) === null || _a === void 0
            ? void 0
            : _a.addresses) === null || _b === void 0
          ? void 0
          : _b[chainId]
      toTokenAddress =
        (_d =
          (_c = tokens[toTokenSymbol]) === null || _c === void 0
            ? void 0
            : _c.addresses) === null || _d === void 0
          ? void 0
          : _d[chainId]
      fromTokenDecimals =
        (_f =
          (_e = tokens[fromTokenSymbol]) === null || _e === void 0
            ? void 0
            : _e.decimals) === null || _f === void 0
          ? void 0
          : _f[chainId]
      toTokenDecimals =
        (_h =
          (_g = tokens[toTokenSymbol]) === null || _g === void 0
            ? void 0
            : _g.decimals) === null || _h === void 0
          ? void 0
          : _h[chainId]
      ...
      amount = bignumber_1.BigNumber.from(query.amount).mul(
        TEN.pow(fromTokenDecimals)
      )
...
app.get('/bridge', function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    let query; var fromChain; var toChain; var fromTokenSymbol; var toTokenSymbol; var fromTokenAddress; var toTokenAddress; var fromTokenDecimals; var toTokenDecimals; var amount;
    let _a; var _b; var _c; var _d; var _e; var _f; var _g; var _h
    return __generator(this, function (_j) {
      query = req.query
...
app.get('/swapTxInfo', function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    let query; var chainId; var fromTokenSymbol; var toTokenSymbol; var fromTokenAddress; var toTokenAddress; var fromTokenDecimals; var toTokenDecimals; var amount;
    let _a; var _b; var _c; var _d; var _e; var _f; var _g; var _h
    return __generator(this, function (_j) {
...
//BridgeTxInfo
app.get('/bridgeTxInfo', function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    let query; var fromChain; var toChain; var fromTokenSymbol; var toTokenSymbol; var fromTokenAddress; var toTokenAddress; var fromTokenDecimals; var toTokenDecimals; var destAddress; var routerAddress; var amount;
    let _a; var _b; var _c; var _d; var _e; var _f; var _g; var _h
    return __generator(this, function (_j) {
      query = req.query
      fromChain = query.fromChain
