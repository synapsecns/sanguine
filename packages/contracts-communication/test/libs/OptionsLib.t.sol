...
contract OptionsLibTest is Test {
    ...
    function test_encodeOptionsV1Roundtrip(OptionsV1 memory options) public view {
    ...
    function test_decodeOptionsV1_decodesV2(MockOptionsV2 memory options) public view {
