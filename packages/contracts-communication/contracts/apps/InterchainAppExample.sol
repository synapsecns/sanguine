...
contract InterchainAppExample is InterchainAppBase, Ownable {
    event MessageReceived(uint256 srcChainId, bytes32 sender, uint64 nonce, bytes message);
    ...
    function _receiveMessage(
        ...
        override
    {
        emit MessageReceived(srcChainId, sender, nonce, message);
    }
}
