...
/// @dev See Execution.sol: (uint8,uint32,uint32,unt32,uint32,address,address,tips): 1+4+4+4+4+20+20+tips_length
uint256 constant EXECUTION_LENGTH = 57 + TIPS_LENGTH;
