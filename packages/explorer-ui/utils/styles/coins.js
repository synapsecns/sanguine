...
import {DOG, GOHM, HIGHSTREET, JUMP, NEWO, NFD, SDT, SFI, SOLAR, VSTA,} from '@constants/tokens/mintable'

const COLOR_COIN_MAP = {
  gray: [FRAX, GOHM, SDT, VSTA],
  yellow: [BUSD, DOG, NFD, NEWO],
  green: [USDT],
  lime: [JEWEL, WJEWEL, XJEWEL, SYNJEWEL, MULTIJEWEL],
  sky: [WETH, WETHE, FTMETH, ONEETH, METISETH, WETHBEAM],
  blue: [USDC, DFK_USDC, UST],
  orange: [DAI, SOLAR],
  purple: [NUSD, NETH, SYN, WMOVR, MOVR],
  indigo: [MIM],
  cyan: [HIGHSTREET, JUMP, AVWETH],
