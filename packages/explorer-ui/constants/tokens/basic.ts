...
// @ts-expect-error TS(2345): Argument of type '{ addresses: { [x: number]: stri... Remove this comment to see the full error message
...
// @ts-expect-error TS(2345): Argument of type '{ addresses: { [x: number]: any;... Remove this comment to see the full error message
