          ...
          <div className="flex mt-4 flex-col">
            ...
            <div className='flex  mt-8  flex-col'>
              ...
              <div className="flex gap-x-[1.6rem] py-1">
                <p className="text-white text-opacity-60">Contract</p>
                <a target="_blank"
                  rel="noreferrer" className="text-white break-all text-sm underline" href={CHAIN_EXPLORER_URLS[toInfo?.chainID ?? fromInfo.destinationChainID] + "/address/" + BRIDGE_CONTRACTS[toInfo?.chainID ?? fromInfo.destinationChainID]}>Destination Bridge Contract
                </a>
              </div>
