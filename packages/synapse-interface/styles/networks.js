...
export function getNetworkButtonBgClassNameActive(chainId) {
  switch (NETWORK_COLORS[chainId]) {
    ...
    case 'green':
      return 'dark:active:!bg-green-700 '
    default:
      return ''
  }
}
...
export function getNetworkHoverShadow(chainId) {
  switch (NETWORK_COLORS[chainId]) {
    case 'yellow':
      return 'dark:!shadow-yellow-lg dark:hover:!shadow-yellow-2xl'
    case 'eth':
      return 'dark:!shadow-blue-lg dark:hover:!shadow-blue-2xl'
    case 'purple':
      return 'dark:!shadow-purple-lg dark:hover:!shadow-purple-2xl'
    case 'blue':
      return 'dark:!shadow-blue-lg dark:hover:!shadow-blue-2xl'
    case 'lime':
      return 'dark:!shadow-lime-lg dark:hover:!shadow-lime-2xl'
    case 'gray':
      return 'dark:!shadow-lg dark:hover:!shadow-2xl'
    case 'red':
      return 'dark:!shadow-red-lg dark:hover:!shadow-red-2xl'
    case 'cyan':
      return 'dark:!shadow-cyan-lg dark:hover:!shadow-cyan-2xl'
    case 'teal':
      return 'dark:!shadow-teal-lg dark:hover:!shadow-teal-2xl'
    case 'orange':
      return 'dark:!shadow-orange-lg dark:hover:!shadow-orange-2xl'
    case 'green':
      return 'dark:!shadow-green-lg dark:hover:!shadow-green-2xl'
    default:
      return ''
  }
}
...
export function getNetworkHover(chainId) {
  switch (NETWORK_COLORS[chainId]) {
    ...
    case 'teal':
      return 'hover:!bg-teal-500 hover:!bg-opacity-20'
    case 'orange':
      return 'hover:!bg-orange-500 hover:!bg-opacity-20'
    case 'green':
      return 'hover:!bg-green-500 hover:!bg-green-20'
    default:
      return ''
  }
}
