...
const COLOR_NETWORK_MAP = {
  eth: [CHAINS.ETH.id],
  gray: [CHAINS.ARBITRUM.id],
  yellow: [CHAINS.BNB.id],
  green: [],
  sky: [],
  teal: [CHAINS.MOONBEAM.id, CHAINS.METIS.id, CHAINS.CANTO.id],
  blue: [CHAINS.FANTOM.id, CHAINS.CRONOS.id],
  orange: [CHAINS.KLAYTN.id],
  purple: [CHAINS.POLYGON.id, CHAINS.MOONRIVER.id, CHAINS.DOGE.id],
  indigo: [],
  cyan: [CHAINS.HARMONY.id],
  lime: [CHAINS.BOBA.id, CHAINS.AURORA.id, CHAINS.DFK.id],
  red: [CHAINS.AVALANCHE.id, CHAINS.OPTIMISM.id],
}
...
export function getNetworkCurrencyColor(chainId) {
  switch (parseInt(chainId)) {
    case CHAINS.BNB.id: return "text-[#ecae0b] dark:text-[#ecae0b]"
    case CHAINS.ETH.id: return ETH_CURRENCY_TEXT_CLASSNAME
    case CHAINS.POLYGON.id: return "text-purple-500 dark:text-purple-500"
    case CHAINS.FANTOM.id: return "text-blue-500 dark:text-blue-500"
    case CHAINS.CRONOS.id: return "text-blue-500 dark:text-blue-500"
    case CHAINS.BOBA.id: return ETH_CURRENCY_TEXT_CLASSNAME
    case CHAINS.ARBITRUM.id: return ETH_CURRENCY_TEXT_CLASSNAME
    case CHAINS.OPTIMISM.id: return ETH_CURRENCY_TEXT_CLASSNAME
    case CHAINS.AURORA.id: return ETH_CURRENCY_TEXT_CLASSNAME
    case CHAINS.AVALANCHE.id: return "text-red-500 dark:text-red-500"
    case CHAINS.DFK.id: return "text-lime-500 dark:text-lime-500"
    case CHAINS.HARMONY.id: return "text-cyan-500 dark:text-cyan-500"
    case CHAINS.MOONBEAM.id: return "text-teal-500 dark:text-teal-500"
    case CHAINS.METIS.id: return "text-teal-500 dark:text-teal-500"
    case CHAINS.KLAYTN.id: return "text-orange-500 dark:text-orange-500"
    case CHAINS.CANTO.id: return "text-green-500 dark:text-green-500"
    default:
      return ""
  }
}
