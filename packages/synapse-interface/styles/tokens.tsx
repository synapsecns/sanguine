...
} from '@constants/tokens/swapMaster'
...
for (const [colorName, tokenArr] of Object.entries(COLOR_COIN_MAP)) {
  for (const someCoin of tokenArr) {
    COIN_COLORS[someCoin.symbol] = colorName
  }
}

const SWAP_COLOR_COIN_MAP = {
  gray: [ETH_POOL_SWAP_TOKEN],
  yellow: [],
  green: [],
  sky: [
    OPTIMISM_ETH_SWAP_TOKEN,
...
for (const [colorName, tokenArr] of Object.entries(SWAP_COLOR_COIN_MAP)) {
  for (const someCoin of tokenArr) {
 ...
 * @param {Token} token
 */
export function getButtonStyleForCoin(token) {
  switch (COIN_COLORS[token.symbol]) {
    case 'yellow':
 ...
 * @param {Token} token
 */
export function getMenuItemStyleForCoin(token) {
  switch (COIN_COLORS[token.symbol]) {
    case 'yellow':
 ...
 * @param {Token} token
 */
export function getMenuItemStyleForCoinDark(token) {
  switch (COIN_COLORS[token.symbol]) {
    case 'yellow':
...
export function getMenuItemStyleForCoinCombined(token) {
  return `${getMenuItemStyleForCoin(token)} ${getMenuItemStyleForCoinDark(
    token
  )}`
}
 ...
 * @param {Token} token
 */
export function getSwapHoverStyleForCoin(token) {
  switch (COIN_COLORS[token.symbol]) {
    case 'yellow':
 ...
 * @param {Token} token
 */
export function getMenuItemBgForCoin(token) {
  switch (COIN_COLORS[token.symbol]) {
    case 'yellow':
 ...
 * @param {Token} token
 */
export function getMenuItemHoverBgForCoin(token) {
  switch (COIN_COLORS[token.symbol]) {
    case 'yellow':
 ...
 * @param {Token} token
 */
export function getCoinTextColor(token) {
  switch (COIN_COLORS[token.symbol]) {
    case 'yellow':
...
export function getCoinTextColorDark(token) {
  switch (COIN_COLORS[token.symbol]) {
    case 'yellow':
...
export function getCoinTextColorAlt(token) {
  switch (COIN_COLORS[token.symbol]) {
    case 'yellow':
      return 'dark:text-yellow-500 dark:group-hover:text-yellow-400'
    case 'green':
...
export function getCoinTextColorCombined(token) {
  return `${getCoinTextColor(token)} ${getCoinTextColorDark(token)}`
}
/**
 ...
 * @param {Token} token
 */
export function getInputBorderFocusStyleForCoin(token) {
  switch (COIN_COLORS[token.symbol]) {
    case 'yellow':
 ...
 * @param {Token} token
 */
export function getSwapBorderStyleForCoin(token) {
  switch (COIN_COLORS[token.symbol]) {
    case 'yellow':
 ...
 * @param {Token} token
 */
export function getSwapBorderHoverStyleForCoin(token) {
  switch (COIN_COLORS[token?.symbol]) {
    case 'yellow':
 ...
 * @param {Token} token
 */
export function getBorderStyleForCoin(token) {
  switch (COIN_COLORS[token.symbol]) {
    case 'yellow':
 ...
 * @param {Token} token
 */
export function getFromStyleForCoin(token) {
  switch (COIN_COLORS[token.symbol]) {
    case 'yellow':
 ...
 * @param {Token} token
 */
export function getToStyleForCoin(token) {
  switch (COIN_COLORS[token.symbol]) {
    case 'yellow':
 ...
 * @param {Token} token
 */
export function getSwapCardShadowStyleForCoin(token) {
  switch (COIN_COLORS[token.symbol]) {
    case 'yellow':
 ...
 * @param {Token} token
 */
export function getBorderStyleForCoinHover(token) {
  switch (COIN_COLORS[token.symbol]) {
    case 'yellow':
