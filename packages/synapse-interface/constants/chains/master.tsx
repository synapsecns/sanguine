...
import {
  ETH as ETH_Token,
  AVAX as AVAX_Token,
  MATIC as MATIC_Token,
  JEWEL as JEWEL_Token,
  KLAY as KLAY_Token,
  FTM as FTM_Token,
...
export const AVALANCHE: Chain = {
  ...
  nativeCurrency: {
    addresses: AVAX_Token.addresses,
    name: AVAX_Token.name,
    symbol: AVAX_Token.symbol,
    decimals: AVAX_Token.decimals,
    icon: avalancheImg,
  },
...
export const POLYGON: Chain = {
  ...
  nativeCurrency: {
    addresses: MATIC_Token.addresses,
    name: MATIC_Token.name,
    symbol: MATIC_Token.symbol,
    decimals: MATIC_Token.decimals,
    icon: polygonImg,
  },
...
export const DFK: Chain = {
  ...
  nativeCurrency: {
    addresses: JEWEL_Token.addresses,
    name: JEWEL_Token.name,
    symbol: JEWEL_Token.symbol,
    decimals: JEWEL_Token.decimals,
    icon: dfkImg,
  },
...
export const KLAYTN: Chain = {
  ...
  nativeCurrency: {
    addresses: KLAY_Token.addresses,
    name: KLAY_Token.name,
    symbol: KLAY_Token.symbol,
    decimals: KLAY_Token.decimals,
    icon: klaytnImg,
  },
...
export const FANTOM: Chain = {
  ...
  nativeCurrency: {
    addresses: FTM_Token.addresses,
    name: FTM_Token.name,
    symbol: FTM_Token.symbol,
    decimals: FTM_Token.decimals,
    icon: fantomImg,
  },
