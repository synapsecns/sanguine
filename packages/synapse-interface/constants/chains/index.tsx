...
// @dev TO-DO: Remove Arbitrum from paused chains once network congestion is over
export const PAUSED_FROM_CHAIN_IDS = [all.ARBITRUM.id]
export const PAUSED_TO_CHAIN_IDS = [all.DOGE.id, all.ARBITRUM.id]
