export const BRIDGE_MAP = {
  '1': {
    ...
    '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48': {
      ...
      destination: ['CCTP.USDC', 'RFQ.USDC', 'USDC', 'nUSD'],
      swappable: [
        '0x1B84765dE8B7566e4cEAF4D0fD3c5aF52D3DdE4F',
        '0x5f98805A4E8be255a32880FDeC7F6728C6568bA0',
        '0x6B175474E89094C44Da98b954EedeAC495271d0F',
    ...
    '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE': {
      decimals: 18,
      symbol: 'ETH',
      origin: ['Gas.zip', 'RFQ.ETH', 'RFQ.USDC', 'nETH'],
      destination: ['Gas.zip', 'RFQ.ETH', 'nETH'],
      swappable: [],
    },
    '0xb753428af26E81097e7fD17f40c88aaA3E04902c': {
      decimals: 18,
      symbol: 'SFI',
      origin: ['RFQ.ETH', 'RFQ.USDC', 'SFI'],
      destination: ['SFI'],
      swappable: [],
    },
    '0xdAC17F958D2ee523a2206206994597C13D831ec7': {
  ...
  '10': {
    '0x0b2C639c533813f4Aa9D7837CAf62653d097Ff85': {
      decimals: 6,
      symbol: 'USDC',
      origin: ['CCTP.USDC', 'RFQ.ETH', 'RFQ.USDC', 'nUSD'],
  ...
  '137': {
    ...
    '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE': {
      decimals: 18,
      symbol: 'POL',
      origin: ['Gas.zip', 'MATIC'],
      destination: ['Gas.zip', 'MATIC'],
      swappable: [],
    },
    '0xc2132D05D31c914a87C6611C10748AEb04B58e8F': {
      decimals: 6,
  ...
  '1088': {
    ...
    '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE': {
      decimals: 18,
      symbol: 'Metis',
      origin: ['Gas.zip', 'Metis'],
      destination: ['Gas.zip', 'Metis'],
      swappable: [],
    },
  ...
  '8453': {
    '0x417Ac0e078398C154EdFadD9Ef675d30Be60Af93': {
      decimals: 18,
      symbol: 'crvUSD',
      origin: ['CCTP.USDC', 'RFQ.ETH', 'RFQ.USDC'],
      destination: ['CCTP.USDC'],
      swappable: [
