  ...
  return (
    <div className="flex-none">
      ...
      >
        ...
        <span>
          {label && (
            <div className="text-left text-sm text-secondary">{label}</div>
          )}
          {defaultName ?? type}
        </span>{' '}
      ...
      <div className="absolute pt-1.5 hidden hover:block peer-hover:block peer-focus:block animate-slide-down origin-top-left z-10 whitespace-nowrap">
        <table className="rounded border-separate border-spacing-0 shadow bg-white dark:bg-bgBase backdrop-blur-sm border border-zinc-200 dark:border-zinc-700 block max-h-[372px] overflow-y-scroll">
          <thead className="text-sm cursor-default">
            <tr>
              <th className="font-normal px-4 pt-3 pb-2 sticky top-0 bg-white/90 dark:bg-bgBase backdrop-blur-sm border-b border-zinc-300 dark:border-zinc-800 text-secondary text-left">
                {type}
              </th>
              {/* <th className="font-normal px-4 pt-3 pb-2 sticky top-0 bg-white/90 dark:bg-bgBase backdrop-blur-sm border-b border-zinc-300 dark:border-zinc-800 text-zinc-500 text-right">
                {header}
              </th> */}
            </tr>
          </thead>
            ...
            {arr.map((item, i) => {
              ...
              return (
                <tr
                  ...
                  className="hover:bg-zinc-100 hover:dark:bg-bgLight cursor-default"
                >
