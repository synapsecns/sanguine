const Chains = ['Ethereum', 'Arbitrum', 'Avalanche', 'Base', 'BNB Chain', 'Optimism', 'Polygon', 'DFK Chain', 'Canto', 'Fantom', 'Klaytn', 'Aurora', 'Boba Chain', 'Cronos', 'Metis', 'Moonbeam', 'Moonriver']

const Tokens = ['USDC', 'USDT', 'DAI', 'crvUSD', 'FRAX', 'LUSD', 'JEWEL', 'AVAX', 'BTC.b', 'AVAX', 'LINK', 'ETH', 'SYN', 'NOTE', 'sUSD', 'GMX', 'MATIC', 'MOVR', 'gOHM', 'H2O', 'L2DAO', 'NEWO', 'PLS', 'SDT', 'SFI', 'UNIDX', 'veSOLAR', 'VSTA']
...
export const generateTx = () => {
  let originAmount = Math.random() < .5 ? Math.round(Math.random() * 10000) : Math.random()
