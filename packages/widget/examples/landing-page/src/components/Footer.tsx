    ...
    <footer>
      <div>
        <a href="https://synapseprotocol.com/landing">
          <picture>
            <source
              srcSet="synapse-logo-onLight.svg"
              media="(prefers-color-scheme: light)"
            />
            <source
              srcSet="synapse-logo-onDark.svg"
        ...
        <nav>
          ...
          <FooterSection
            ...
            links={[
              {
                label: 'Build on Synapse',
                url: 'https://docs.synapseprotocol.com/synapse-interchain-network-sin/build-on-the-synapse-interchain-network',
              },
              {
                label: 'Documentation',
