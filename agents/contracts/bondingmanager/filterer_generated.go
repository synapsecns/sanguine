...
type IBondingManagerFilterer interface {
	...
	FilterAgentRootProposed(opts *bind.FilterOpts) (*BondingManagerAgentRootProposedIterator, error)
	...
	//
	// Solidity: event AgentRootProposed(bytes32 newRoot)
	WatchAgentRootProposed(opts *bind.WatchOpts, sink chan<- *BondingManagerAgentRootProposed) (event.Subscription, error)
	...
	//
	// Solidity: event AgentRootProposed(bytes32 newRoot)
	ParseAgentRootProposed(log types.Log) (*BondingManagerAgentRootProposed, error)
	...
	FilterOwnershipTransferStarted(opts *bind.FilterOpts, previousOwner []common.Address, newOwner []common.Address) (*BondingManagerOwnershipTransferStartedIterator, error)
	// WatchOwnershipTransferStarted is a free log subscription operation binding the contract event 0x38d16b8cac22d99fc7c124b9cd0de2d3fa1faef420bfe791d8c362d765e22700.
	//
	// Solidity: event OwnershipTransferStarted(address indexed previousOwner, address indexed newOwner)
	WatchOwnershipTransferStarted(opts *bind.WatchOpts, sink chan<- *BondingManagerOwnershipTransferStarted, previousOwner []common.Address, newOwner []common.Address) (event.Subscription, error)
	// ParseOwnershipTransferStarted is a log parse operation binding the contract event 0x38d16b8cac22d99fc7c124b9cd0de2d3fa1faef420bfe791d8c362d765e22700.
	//
	// Solidity: event OwnershipTransferStarted(address indexed previousOwner, address indexed newOwner)
	ParseOwnershipTransferStarted(log types.Log) (*BondingManagerOwnershipTransferStarted, error)
	...
	FilterProposedAgentRootCancelled(opts *bind.FilterOpts) (*BondingManagerProposedAgentRootCancelledIterator, error)
	...
	//
	// Solidity: event ProposedAgentRootCancelled(bytes32 proposedRoot)
	WatchProposedAgentRootCancelled(opts *bind.WatchOpts, sink chan<- *BondingManagerProposedAgentRootCancelled) (event.Subscription, error)
	...
	//
	// Solidity: event ProposedAgentRootCancelled(bytes32 proposedRoot)
	ParseProposedAgentRootCancelled(log types.Log) (*BondingManagerProposedAgentRootCancelled, error)
	...
	FilterProposedAgentRootResolved(opts *bind.FilterOpts) (*BondingManagerProposedAgentRootResolvedIterator, error)
	...
	//
	// Solidity: event ProposedAgentRootResolved(bytes32 proposedRoot)
	WatchProposedAgentRootResolved(opts *bind.WatchOpts, sink chan<- *BondingManagerProposedAgentRootResolved) (event.Subscription, error)
	...
	//
	// Solidity: event ProposedAgentRootResolved(bytes32 proposedRoot)
	ParseProposedAgentRootResolved(log types.Log) (*BondingManagerProposedAgentRootResolved, error)
