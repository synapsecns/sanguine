...
//go:generate go run github.com/vburenin/ifacemaker -f arbgasinfo.abigen.go -s ArbGasInfoTransactor -i IArbGasInfoTransactor -p arbgasinfo -o itransactor_generated.go -c "autogenerated file"
