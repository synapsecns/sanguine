...
LABEL org.label-schema.description="RFQ API Dockerfile"
LABEL org.label-schema.name="ghcr.io/synapsecns/sanguine/services/rfq/api"
...
LABEL org.opencontainers.image.description="RFQ API Docker image"
