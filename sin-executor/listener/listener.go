...
type chainListener struct {
	client   client.EVM
	contract *interchainclient.InterchainClientRef
	store    db.Service
...
func NewChainListener(omnirpcClient client.EVM, store db.Service, address common.Address, handler metrics.Handler) (ContractListener, error) {
	interchainClient, err := interchainclient.NewInterchainClientRef(address, omnirpcClient)
	if err != nil {
