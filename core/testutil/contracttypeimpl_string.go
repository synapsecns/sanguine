...
func _() {
	...
	_ = x[AttestationCollectorType-5]
}

const _contractTypeImpl_name = "HomeXAppConfigMessageHarnessHomeHarnessUpdaterManagerAttestationCollector"

var _contractTypeImpl_index = [...]uint8{0, 4, 14, 28, 39, 53, 73}
