...
//go:generate go run github.com/synapsecns/sanguine/tools/bundle -prefix "" -tags "!codeanalysis" -pkg manifest -o manifest_gen.go github.com/hashicorp/terraform-provider-kubernetes/manifest/provider
