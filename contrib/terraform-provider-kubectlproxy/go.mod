module github.com/synapsecns/sanguine/contrib/terraform-provider-kubectlproxy

go 1.19

require (
	github.com/gavinbunney/terraform-provider-kubectl v0.0.0-00010101000000-000000000000
...
replace (
	github.com/gavinbunney/terraform-provider-kubectl => github.com/michielboekhoff/terraform-provider-kubectl v0.0.0-20220907100506-15f7c60ab415
