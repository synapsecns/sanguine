...
replace (
	...
	github.com/synapsecns/sanguine/contrib/terraform-provider-iap => ../../contrib/terraform-provider-iap
...
require (
	...
	github.com/synapsecns/sanguine/contrib/terraform-provider-iap v0.0.17
)
