...
replace (
	github.com/synapsecns/sanguine/contrib/terraform-provider-iap => ../terraform-provider-iap
...
require (
	...
	github.com/synapsecns/sanguine/contrib/terraform-provider-iap v0.0.0-00010101000000-000000000000
)
