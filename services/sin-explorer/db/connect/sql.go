// Package connect contains the database connection logic for the sin explorer.
...
import (
	...
	"github.com/synapsecns/sanguine/services/sin-explorer/db/mysql"
	"github.com/synapsecns/sanguine/services/sin-explorer/db/sqlite"
)
