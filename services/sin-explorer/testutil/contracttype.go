...
const (
	// InterchainClientEventMock is the interchain mock.
	InterchainClientEventMock contractTypeImpl = iota + 1 // InterchainClientEventMock
)
...
func (c contractTypeImpl) ContractInfo() *compiler.Contract {
	switch c {
	case InterchainClientEventMock:
		return interchainclienteventmock.Contracts["solidity/InterchainClientEventMock.sol:InterchainClientEventMock"]
	}
	return nil
}
