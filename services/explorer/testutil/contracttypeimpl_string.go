...
func _() {
	...
	_ = x[MessageBusUpgradableType-3]
}

const _contractTypeImpl_name = "BridgeConfigTypeV3SynapseBridgeTypeSwapFlashLoanTypeMessageBusUpgradableType"

var _contractTypeImpl_index = [...]uint8{0, 18, 35, 52, 76}
