...
func _() {
	...
	_ = x[MetaSwapType-5]
	_ = x[CCTPType-6]
	_ = x[FastBridgeType-7]
}

const _contractTypeImpl_name = "BridgeConfigTypeV3SynapseBridgeTypeSwapFlashLoanTypeSynapseBridgeV1TypeMessageBusTypeMetaSwapTypeCCTPTypeFastBridgeType"

var _contractTypeImpl_index = [...]uint8{0, 18, 35, 52, 71, 85, 97, 105, 119}
