...
//go:generate go run github.com/synapsecns/sanguine/tools/abigen generate --sol ./contract/TestSynapseBridgeV1.sol --pkg testbridgev1 --sol-version 0.6.12 --filename testbridgev1
