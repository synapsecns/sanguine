...
//
// Solidity: function testMintAndSwap(address to, address token, uint256 amount, uint256 fee, address swap, uint8 tokenIndexFrom, uint8 tokenIndexTo, uint256 minDy, uint256 deadline, bytes32 kappa) returns()
...
//
// Solidity: function testWithdrawAndRemove(address to, address token, uint256 amount, uint256 fee, address swap, uint8 swapTokenIndex, uint256 swapMinAmount, uint256 swapDeadline, bytes32 kappa) returns()
