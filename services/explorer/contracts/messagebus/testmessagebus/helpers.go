...
// NewTestMessagingRef gets a bound Messaging Bus Upgradeable contract and the address of the contract
// nolint: golint
func NewTestMessagingRef(address common.Address, backend bind.ContractBackend) (*TestMessageBusRef, error) {
