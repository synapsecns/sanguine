...
func (m MessageBusUpgradeableExecuted) GetMessageID() *string {
	messageID := common.Bytes2Hex(m.MessageId[:])
	return &messageID
}
...
// GetEventType gets the execute event type.
func (m MessageBusUpgradeableCallReverted) GetEventType() message.EventType {
	return message.CallRevertedEvent
}
...
var _ message.EventLog = &MessageBusUpgradeableCallReverted{}
