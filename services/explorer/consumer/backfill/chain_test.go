...
func (b *BackfillSuite) TestBackfill() {
	...
	Nil(b.T(), err)
	redeemLog, err := b.storeTestLog(bridgeTx, uint32(testChainID.Uint64()), 0)
	Nil(b.T(), err)
	...
	Nil(b.T(), err)
	withdrawLog, err := b.storeTestLog(bridgeTx, uint32(testChainID.Uint64()), 0)
	Nil(b.T(), err)
	...
	Nil(b.T(), err)
	depositAndSwapLog, err := b.storeTestLog(bridgeTx, uint32(testChainID.Uint64()), 4)
	Nil(b.T(), err)
	bridgeTx, err = bridgeRef.TestRedeemAndSwap(transactOpts.TransactOpts, common.BigToAddress(big.NewInt(gofakeit.Int64())), big.NewInt(int64(gofakeit.Uint32())), common.HexToAddress(testTokens[0].TokenAddress), big.NewInt(int64(gofakeit.Uint32())), gofakeit.Uint8(), gofakeit.Uint8(), big.NewInt(int64(gofakeit.Uint32())), big.NewInt(int64(gofakeit.Uint32())))
	Nil(b.T(), err)
	redeemAndSwapLog, err := b.storeTestLog(bridgeTx, uint32(testChainID.Uint64()), 5)
	Nil(b.T(), err)
	...
	Nil(b.T(), err)
	redeemAndRemoveLog, err := b.storeTestLog(bridgeTx, uint32(testChainID.Uint64()), 6)
	Nil(b.T(), err)
	...
	Nil(b.T(), err)
	mintAndSwapLog, err := b.storeTestLog(bridgeTx, uint32(testChainID.Uint64()), 7)
	Nil(b.T(), err)
	...
	Nil(b.T(), err)
	addLiquidityLog, err := b.storeTestLog(swapTx, uint32(testChainID.Uint64()), 1)
	Nil(b.T(), err)
	...
	Nil(b.T(), err)
	removeLiquidityLog, err := b.storeTestLog(swapTx, uint32(testChainID.Uint64()), 1)
	Nil(b.T(), err)
	...
	Nil(b.T(), err)
	removeLiquidityOneLog, err := b.storeTestLog(swapTx, uint32(testChainID.Uint64()), 3)
	Nil(b.T(), err)
	...
	Nil(b.T(), err)
	removeLiquidityImbalanceLog, err := b.storeTestLog(swapTx, uint32(testChainID.Uint64()), 4)
	Nil(b.T(), err)
