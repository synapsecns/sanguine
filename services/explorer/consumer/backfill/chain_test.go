...
func (b *BackfillSuite) TestBackfill() {
	...
	Nil(b.T(), err)
	swapTx, err = swapRef.TestAddLiquidity(transactOpts.TransactOpts, common.BigToAddress(big.NewInt(gofakeit.Int64())), []*big.Int{big.NewInt(int64(gofakeit.Uint64()))}, []*big.Int{big.NewInt(int64(gofakeit.Uint64()))}, big.NewInt(int64(gofakeit.Uint64())), big.NewInt(int64(gofakeit.Uint64())))
	Nil(b.T(), err)
	err = b.storeTestLog(swapTx, []common.Hash{swapTopicsMap[swapTypes.TokenSwapEvent], common.BigToHash(big.NewInt(gofakeit.Int64()))}, swapContract.Address(), uint32(testChainID.Uint64()), 1)
	Nil(b.T(), err)
	...
	Nil(b.T(), err)
	err = b.storeTestLog(swapTx, []common.Hash{swapTopicsMap[swapTypes.TokenSwapEvent], common.BigToHash(big.NewInt(gofakeit.Int64()))}, swapContract.Address(), uint32(testChainID.Uint64()), 2)
	Nil(b.T(), err)
	...
	Nil(b.T(), err)
	swapTx, err = swapRef.TestRemoveLiquidityImbalance(transactOpts.TransactOpts, common.BigToAddress(big.NewInt(gofakeit.Int64())), []*big.Int{big.NewInt(int64(gofakeit.Uint64()))}, []*big.Int{big.NewInt(int64(gofakeit.Uint64()))}, big.NewInt(int64(gofakeit.Uint64())), big.NewInt(int64(gofakeit.Uint64())))
	Nil(b.T(), err)
	err = b.storeTestLog(swapTx, []common.Hash{swapTopicsMap[swapTypes.TokenSwapEvent], common.BigToHash(big.NewInt(gofakeit.Int64()))}, swapContract.Address(), uint32(testChainID.Uint64()), 4)
	Nil(b.T(), err)
	...
	Nil(b.T(), err)
	err = b.storeTestLog(swapTx, []common.Hash{swapTopicsMap[swapTypes.NewAdminFeeEvent]}, swapContract.Address(), uint32(testChainID.Uint64()), 5)
	Nil(b.T(), err)
	swapTx, err = swapRef.TestNewSwapFee(transactOpts.TransactOpts, big.NewInt(int64(gofakeit.Uint64())))
	Nil(b.T(), err)
	err = b.storeTestLog(swapTx, []common.Hash{swapTopicsMap[swapTypes.NewSwapFeeEvent]}, swapContract.Address(), uint32(testChainID.Uint64()), 6)
	Nil(b.T(), err)
	...
	Nil(b.T(), err)
	err = b.storeTestLog(swapTx, []common.Hash{swapTopicsMap[swapTypes.RampAEvent]}, swapContract.Address(), uint32(testChainID.Uint64()), 7)
	Nil(b.T(), err)
	...
	Nil(b.T(), err)
	err = b.storeTestLog(swapTx, []common.Hash{swapTopicsMap[swapTypes.StopRampAEvent]}, swapContract.Address(), uint32(testChainID.Uint64()), 8)
	Nil(b.T(), err)
	swapTx, err = swapRef.TestFlashLoan(transactOpts.TransactOpts, common.BigToAddress(big.NewInt(gofakeit.Int64())), gofakeit.Uint8(), big.NewInt(int64(gofakeit.Uint64())), big.NewInt(int64(gofakeit.Uint64())), big.NewInt(int64(gofakeit.Uint64())))
	Nil(b.T(), err)
	err = b.storeTestLog(swapTx, []common.Hash{swapTopicsMap[swapTypes.FlashLoanEvent], common.BigToHash(big.NewInt(gofakeit.Int64()))}, swapContract.Address(), uint32(testChainID.Uint64()), 9)
	Nil(b.T(), err)
	//// Store 20 logs
