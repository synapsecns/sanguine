...
func NewMessageBusParser(consumerDB db.ConsumerDB, messageBusAddress common.Address, consumerFetcher scribe.IScribeFetcher, tokenPriceService price.IPriceFetcher) (*MessageBusParser, error) {
