...
type Parser interface {
	...
	ParseAndStore(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error
}
...
func (p *BridgeParser) parseAndStoreDeposit(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error {
	...
	err = p.consumerDB.StoreEvent(ctx, iface, nil, chainID, tokenID, sender)
	if err != nil {
...
func (p *BridgeParser) parseAndStoreRedeem(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error {
...
func (p *BridgeParser) parseAndStoreWithdraw(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error {
...
func (p *BridgeParser) parseAndStoreMint(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error {
...
func (p *BridgeParser) parseAndStoreDepositAndSwap(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error {
...
func (p *BridgeParser) parseAndStoreMintAndSwap(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error {
...
func (p *BridgeParser) parseAndStoreRedeemAndSwap(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error {
...
func (p *BridgeParser) parseAndStoreRedeemAndRemove(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error {
...
func (p *BridgeParser) parseAndStoreWithdrawAndRemove(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error {
...
func (p *BridgeParser) parseAndStoreRedeemV2(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error {
...
func (p *SwapParser) parseTokenSwap(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error {
	iface, err := p.Filterer.ParseTokenSwap(log)
	if err != nil {
		return fmt.Errorf("could not parse token swap: %w", err)
	}
	err = p.consumerDB.StoreEvent(ctx, nil, iface, chainID, nil, sender)
	if err != nil {
		return fmt.Errorf("could not store token swap: %w", err)
	}
	return nil
...
func (p *SwapParser) parseAddLiquidity(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error {
...
func (p *SwapParser) parseRemoveLiquidity(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error {
...
func (p *SwapParser) parseRemoveLiquidityOne(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error {
...
func (p *SwapParser) parseRemoveLiquidityImbalance(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error {
...
func (p *SwapParser) parseNewAdminFee(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error {
...
func (p *SwapParser) parseNewSwapFee(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error {
...
func (p *SwapParser) parseRampA(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error {
...
func (p *SwapParser) parseStopRampA(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error {
...
func (p *SwapParser) parseFlashLoan(ctx context.Context, log ethTypes.Log, chainID uint32, sender string) error {
