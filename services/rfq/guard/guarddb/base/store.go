...
func NewStore(db *gorm.DB, metrics metrics.Handler) *Store {
	...
	return &Store{ChainListenerDB: listenerDB.NewChainListenerStore(db, metrics, "guard"), db: db, submitterStore: txDB}
}
...
func GetAllModels() (allModels []interface{}) {
	allModels = append(txdb.GetAllModels(), &PendingProvenModel{}, &BridgeRequestModel{})
