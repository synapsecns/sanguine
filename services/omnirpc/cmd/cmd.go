...
func Start(args []string, buildInfo config.BuildInfo) {
	...
	app.Commands = []*cli.Command{latencyCommand, chainListCommand, publicConfigCommand, rewriteConfirmProxy, serverCommand, debugResponse, latestRewrite, harmonyProxy, receiptsProxy}
