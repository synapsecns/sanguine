...
@return StreamResultOfV1Log
*/
func (a *ScribeServiceApiService) ScribeServiceWatchLogs(ctx context.Context, body V1WatchLogsRequest) (StreamResultOfV1Log, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue StreamResultOfV1Log
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/grpc/v1/watch_logs"
