...
import (
	...
	types "github.com/synapsecns/sanguine/services/scribe/types"
)
...
// DeleteFailedLog provides a mock function with given fields: ctx, chainID, contractAddress, txHash, blockIndex, blockNumber
func (_m *EventDB) DeleteFailedLog(ctx context.Context, chainID uint32, contractAddress common.Address, txHash common.Hash, blockIndex uint64, blockNumber uint64) error {
	ret := _m.Called(ctx, chainID, contractAddress, txHash, blockIndex, blockNumber)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, uint32, common.Address, common.Hash, uint64, uint64) error); ok {
		r0 = rf(ctx, chainID, contractAddress, txHash, blockIndex, blockNumber)
	} else {
		r0 = ret.Error(0)
	}
...
// GetFailedAttempts provides a mock function with given fields: ctx, chainID, contractAddress, txHash, blockIndex, blockNumber
func (_m *EventDB) GetFailedAttempts(ctx context.Context, chainID uint32, contractAddress common.Address, txHash common.Hash, blockIndex uint64, blockNumber uint64) (uint64, error) {
	ret := _m.Called(ctx, chainID, contractAddress, txHash, blockIndex, blockNumber)

	var r0 uint64
	if rf, ok := ret.Get(0).(func(context.Context, uint32, common.Address, common.Hash, uint64, uint64) uint64); ok {
		r0 = rf(ctx, chainID, contractAddress, txHash, blockIndex, blockNumber)
	} else {
		r0 = ret.Get(0).(uint64)
	}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, uint32, common.Address, common.Hash, uint64, uint64) error); ok {
		r1 = rf(ctx, chainID, contractAddress, txHash, blockIndex, blockNumber)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *EventDB) GetFailedLogsFromFilter(ctx context.Context, failedLogFilter db.FailedLogFilter) ([]types.FailedLog, error) {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, db.FailedLogFilter) error); ok {
		r1 = rf(ctx, failedLogFilter)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *EventDB) RetrieveEthTxsInRange(ctx context.Context, ethTxFilter db.EthTxFilter, startBlock uint64, endBlock uint64, page int) ([]coretypes.Transaction, error) {
	ret := _m.Called(ctx, ethTxFilter, startBlock, endBlock, page)

	var r0 []coretypes.Transaction
	if rf, ok := ret.Get(0).(func(context.Context, db.EthTxFilter, uint64, uint64, int) []coretypes.Transaction); ok {
...
func (_m *EventDB) RetrieveEthTxsWithFilter(ctx context.Context, ethTxFilter db.EthTxFilter, page int) ([]coretypes.Transaction, error) {
	ret := _m.Called(ctx, ethTxFilter, page)

	var r0 []coretypes.Transaction
	if rf, ok := ret.Get(0).(func(context.Context, db.EthTxFilter, int) []coretypes.Transaction); ok {
...
func (_m *EventDB) RetrieveLogsInRange(ctx context.Context, logFilter db.LogFilter, startBlock uint64, endBlock uint64, page int) ([]*coretypes.Log, error) {
	ret := _m.Called(ctx, logFilter, startBlock, endBlock, page)

	var r0 []*coretypes.Log
	if rf, ok := ret.Get(0).(func(context.Context, db.LogFilter, uint64, uint64, int) []*coretypes.Log); ok {
...
func (_m *EventDB) RetrieveLogsWithFilter(ctx context.Context, logFilter db.LogFilter, page int) ([]*coretypes.Log, error) {
	ret := _m.Called(ctx, logFilter, page)

	var r0 []*coretypes.Log
	if rf, ok := ret.Get(0).(func(context.Context, db.LogFilter, int) []*coretypes.Log); ok {
...
func (_m *EventDB) RetrieveReceiptsInRange(ctx context.Context, receiptFilter db.ReceiptFilter, startBlock uint64, endBlock uint64, page int) ([]coretypes.Receipt, error) {
	ret := _m.Called(ctx, receiptFilter, startBlock, endBlock, page)

	var r0 []coretypes.Receipt
	if rf, ok := ret.Get(0).(func(context.Context, db.ReceiptFilter, uint64, uint64, int) []coretypes.Receipt); ok {
...
func (_m *EventDB) RetrieveReceiptsWithFilter(ctx context.Context, receiptFilter db.ReceiptFilter, page int) ([]coretypes.Receipt, error) {
	ret := _m.Called(ctx, receiptFilter, page)

	var r0 []coretypes.Receipt
	if rf, ok := ret.Get(0).(func(context.Context, db.ReceiptFilter, int) []coretypes.Receipt); ok {
...
func (_m *EventDB) StoreEthTx(ctx context.Context, tx *coretypes.Transaction, chainID uint32, blockHash common.Hash, blockNumber uint64, transactionIndex uint64) error {
	ret := _m.Called(ctx, tx, chainID, blockHash, blockNumber, transactionIndex)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *coretypes.Transaction, uint32, common.Hash, uint64, uint64) error); ok {
...
// StoreFailedLog provides a mock function with given fields: ctx, chainID, contractAddress, txHash, blockIndex, blockNumber
func (_m *EventDB) StoreFailedLog(ctx context.Context, chainID uint32, contractAddress common.Address, txHash common.Hash, blockIndex uint64, blockNumber uint64) error {
	ret := _m.Called(ctx, chainID, contractAddress, txHash, blockIndex, blockNumber)
...
func (_m *EventDB) StoreLog(ctx context.Context, log coretypes.Log, chainID uint32) error {
	ret := _m.Called(ctx, log, chainID)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, coretypes.Log, uint32) error); ok {
...
func (_m *EventDB) StoreReceipt(ctx context.Context, receipt coretypes.Receipt, chainID uint32) error {
	ret := _m.Called(ctx, receipt, chainID)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, coretypes.Receipt, uint32) error); ok {
