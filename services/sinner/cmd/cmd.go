...
func Start(args []string, buildInfo config.BuildInfo) {
	...
	app.Description = buildInfo.VersionString() + "Sinner tracks current and historical messages in the Synapse network."
	app.Usage = "Sinner help"
	...
	// commands
	app.Commands = cli.Commands{infoCommand, serverCommand, indexerCommand, unifiedCommand}
