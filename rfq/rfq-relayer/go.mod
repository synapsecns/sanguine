module github.com/synapsecns/sanguine/rfq/rfq-relayer
...
require (
	...
	github.com/synapsecns/sanguine/core v0.0.81
	github.com/synapsecns/sanguine/ethergo v0.0.138
	github.com/synapsecns/sanguine/services/omnirpc v0.0.155
